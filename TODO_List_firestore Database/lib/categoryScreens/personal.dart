...
class personalScreen extends StatefulWidget {
  ...
  personalScreen({required this.onCountUpdate});
  @override
  _DoneScreenState createState() => _DoneScreenState();
}

class _DoneScreenState extends State<personalScreen> {
  bool loading = true;
  List<Map<String, dynamic>> workData = [];
  getDoneData() async {
    QuerySnapshot personalTasks = await FirebaseFirestore.instance
        .collection('categories')
        .where('id', isEqualTo: FirebaseAuth.instance.currentUser!.uid)
        .where('item', isEqualTo: 'personal') // Only fetch done tasks
        .get();

    workData = personalTasks.docs.map((doc) {
    ...
    */
    setState(() {
      personalListCount = personalTasks.docs.length;
      widget.onCountUpdate(personalListCount); // Update count here
      loading = false;
    });
  }
