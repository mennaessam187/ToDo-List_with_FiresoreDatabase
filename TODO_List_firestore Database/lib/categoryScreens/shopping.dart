...
class ShoppingScreen extends StatefulWidget {
  ...
  ShoppingScreen({required this.onCountUpdate});
  @override
  _DoneScreenState createState() => _DoneScreenState();
}

class _DoneScreenState extends State<ShoppingScreen> {
  bool loading = true;
  ...
  getDoneData() async {
    QuerySnapshot workTasks = await FirebaseFirestore.instance
        ...
        .where('item', isEqualTo: 'Shopping') // Only fetch done tasks
        .get();
    ...
    */
    setState(() {
      shoppingListCount = workTasks.docs.length;
      widget.onCountUpdate(shoppingListCount); // Update count here
      loading = false;
    });
  }
