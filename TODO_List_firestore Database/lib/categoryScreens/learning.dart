...
class learningScreen extends StatefulWidget {
  ...
  learningScreen({required this.onCountUpdate});
  @override
  _DoneScreenState createState() => _DoneScreenState();
}

class _DoneScreenState extends State<learningScreen> {
  bool loading = true;
  List<Map<String, dynamic>> workData = [];
  getDoneData() async {
    QuerySnapshot learningTasks = await FirebaseFirestore.instance
        .collection('categories')
        .where('id', isEqualTo: FirebaseAuth.instance.currentUser!.uid)
        .where('item', isEqualTo: 'Learning') // Only fetch done tasks
        .get();

    workData = learningTasks.docs.map((doc) {
    ...
    */
    setState(() {
      personalListCount = learningTasks.docs.length;
